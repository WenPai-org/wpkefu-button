...
class ssb_ui {
	...
	public function button_builder() {
        ...
        <div class="ssb-panel">
            ...
            <header class="ssb-panel-header">
				<?php _e( 'Button Builder', 'wpkefu-button' ); ?>
            </header>
            <div class="ssb-panel-body">
                <p><?php _e( 'Add buttons then drag and drop to reorder them. Click the arrow on the right of each item to reveal more configuration options.', 'wpkefu-button' ); ?></p>
                <p><a href="#" class="button ssb-add-btn"><?php _e( 'Add Button', 'wpkefu-button' ); ?></a></p>
            ...
            <footer class="ssb-panel-footer">
                <input type="submit" class="button-primary"
                       value="<?php _e( 'Save Buttons', 'wpkefu-button' ); ?>">
            </footer>
        </div>
		<?php
		return true;
	...
	function general_settings() {
        ...
        <div class="ssb-panel">
			<?php settings_fields( 'ssb_storage' ); ?>
            <header class="ssb-panel-header">
				<?php _e( 'General Settings', 'wpkefu-button' ); ?>
            </header>
            <div class="ssb-panel-body">
                <div class="ssb-row">
                    <div class="ssb-col">
                        <label for="ssb-pos-left">
                            <strong><?php _e( 'Button Position', 'wpkefu-button' ); ?>:</strong>
                        </label>
                    </div>
                    <div class="ssb-col">
                        <label for="ssb-pos-left">
                ...
                <div class="ssb-row">
                    <div class="ssb-col">
                        <label for="ssb-btn-dark">
                            <strong><?php _e( 'Rollover Style', 'wpkefu-button' ); ?>:</strong>
                        </label>
                    </div>
                    <div class="ssb-col">
                        <label for="ssb-btn-dark">
                ...
                <div class="ssb-row">
                    <div class="ssb-col">
                        <label for="ssb-btn-none">
                            <strong><?php _e( 'Animation', 'wpkefu-button' ); ?>:</strong>
                        </label>
                    </div>
                    <div class="ssb-col">
                        <label for="ssb-btn-none">
                    ...
                    <div class="ssb-col">
                        <label for="ssb-btn-icons">
							...
							<?php _e( 'Icons Only', 'wpkefu-button' ); ?>
                        </label>
                    </div>
                </div>
                ...
                <div class="ssb-row">
                    <div class="ssb-col">
                        <label for="ssb-btn-disable">
                            <strong><?php _e( 'Enable Social Sharing', 'wpkefu-button' ); ?>:</strong>
                        </label>
                    </div>
                    <div class="ssb-col">
                ...
                <div class="ssb-row">
                    <div class="ssb-col">
                        <label for="ssb-btn-disable">
                            <strong><?php _e( 'Disable on Mobile', 'wpkefu-button' ); ?>:</strong>
                        </label>
                    </div>
                    <div class="ssb-col">
                        <label for="ssb-btn-disable">
                ...
                <div class="ssb-row">
                    <div class="ssb-col">
                        <label for="ssb-btn-z-index">
                            <strong><?php _e( 'Z-Index', 'wpkefu-button' ); ?>:</strong>
                        </label>
                    </div>
                    <div class="ssb-col">
                        <input type="number"
                ...
                <div class="ssb-row">
                    <div class="ssb-col">
                        <label>
                            <strong><?php _e( 'Show on', 'wpkefu-button' ); ?>:</strong>
                        </label>
                    </div>
                    <div class="ssb-col">
                        <p>
							...
							foreach ( $this->cpts as $cpt ): ?>
                                <p>
                                    <label for="show-on-<?php echo $cpt->name; ?>">
										...
										<?php _e( $cpt->labels->name, 'wpkefu-button' ); ?>
                                    </label>
                                </p>
                        ...
                        <p>
                            <label for="show-on-frontpage">
								...
								<?php _e( 'Front Page', 'wpkefu-button' ); ?>
                            </label>
                        </p>
                    </div>
                </div>
            ...
            <footer class="ssb-panel-footer">
                <input type="submit" class="button-primary"
                       value="<?php _e( 'Save Settings', 'wpkefu-button' ); ?>">
            </footer>
        </div>
		<?php
		return true;
                            ...
                            <li id="ssb-btn-<?php echo $btn_id; ?>">
                                <p>
                                    <a href="<?php echo $this->buttons['btns'][ $btn_id ]['btn_link']; ?>" <?php echo ( !empty($this->buttons['btns'][ $btn_id ]['open_new_window']) ) ? 'target="_blank"' : ''; ?>><?php
										...
										echo ( isset( $this->buttons['btns'][ $btn_id ]['btn_text'] ) && ( isset( $this->settings['btn_anim'] ) && $this->settings['btn_anim'] != 'icons' ) ) ? __( $this->buttons['btns'][ $btn_id ]['btn_text'], 'wpkefu-button' ) : ' &nbsp; ';
										?></a>
                                </p>
                            </li>
							<?php
