...
1. Visit the new WPKefu Button tab to create your buttons.

== Frequently Asked Questions ==

= My WPKefu Button are covered by some other element. What should I do? =
...
Absolutely! Please create a pull request on [GitHub here.](https://github.com/EnigmaWeb/wpkefu-button)


== Screenshots ==

1. WPKefu Button in action: IN
2. WPKefu Button in action: OUT
3. WPKefu Button backend button creator
4. An example site using WPKefu Button
5. An example site using WPKefu Button
6. An example site using WPKefu Button
